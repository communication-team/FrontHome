...
<input type="text" id="userloginform-phonenumber" class="form-control" onChange={(e)=>setLoginuser(e.target.value)} value={loginuser} name="UserLoginForm[phoneNumber]" dir="ltr" aria-required="true"/>
</div>                </div>
...
<input type="password" id="userloginform-password" class="form-control" onChange={(e)=>setLoginpassword(e.target.value)} value={loginpassword} name="UserLoginForm[password]" dir="ltr" aria-required="true"/>
 ...
 <div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 sa_forms_titles">اسم المستخدم: </div>
                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group field-userloginform-phonenumber required">
<input type="text" onChange={(e)=>setSinguser(e.target.value)}  value={singuser} id="userloginform-phonenumber" class="form-control" name="UserLoginForm[phoneNumber]" dir="ltr" aria-required="true"/>
</div>                </div>
            <div class="col-lg-4 col-md-3 col-sm-12 col-xs-12 sa_forms_notes"></div>
        </div>
        <div class="row">
...
<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
        ...
        <div class="form-group field-userloginform-phonenumber required">
<input type="text"  onChange={(e)=>setemail(e.target.value)}  value={email} id="userloginform-phonenumber" class="form-control" name="UserLoginForm[phoneNumber]" dir="ltr" aria-required="true"/>
</div>                </div>
{/* <div class="col-lg-4 col-md-3 col-sm-12 col-xs-12 sa_forms_notes"></div>
...
<div class='row'>
        ...
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
            <div class="input_elements clearfix">
                ...
                <div class="form-group field-userloginform-password required">
<input type="password" onChange={(e)=>setPassword(e.target.value)}  value={password}  id="userloginform-password" class="form-control" name="UserLoginForm[password]" dir="ltr" aria-required="true"/>
</div>                    <div class="input_elements_lft">
                    <button type="button" class="show_password" id="peye"></button>
                </div>
            </div>  
...
<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                            ...
                            <label class="clearfix">
                                 <a href="" class="btn-registration"> <button type="submit" class="btn btn-primary">سجل الآن </button>   </a></label>
                              </p>
                        </div>
        <div class="col-lg-4 col-md-3 col-sm-12 col-xs-12 sa_forms_notes"></div>
    </div>
